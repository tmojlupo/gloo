...
type SDSConfig struct {
	...
	// Use secret discovery service with a static cluster. It should be configured in envoy's
	// bootstrap config.
	TargetCluster string `protobuf:"bytes,5,opt,name=target_cluster,json=targetCluster,proto3" json:"target_cluster,omitempty"`
	// Call credentials. Used with target_uri.
...
func (m *SDSConfig) GetTargetCluster() string {
	if m != nil {
...
var fileDescriptor_c4a65e8067d81add = []byte{
	...
	,
}
