...
type SslConfig_ConsulEndpoint struct {
	ConsulEndpoint string `protobuf:"bytes,8,opt,name=consul_endpoint,json=consulEndpoint,proto3,oneof" json:"consul_endpoint,omitempty"`
}
...
func (*SslConfig_ConsulEndpoint) isSslConfig_SslSecrets() {}
...
func (m *SslConfig) GetConsulEndpoint() string {
	if x, ok := m.GetSslSecrets().(*SslConfig_ConsulEndpoint); ok {
		return x.ConsulEndpoint
	}
	return ""
}
...
type UpstreamSslConfig struct {
	...
	//	*UpstreamSslConfig_ConsulEndpoint
...
type UpstreamSslConfig_ConsulEndpoint struct {
	ConsulEndpoint string `protobuf:"bytes,9,opt,name=consul_endpoint,json=consulEndpoint,proto3,oneof" json:"consul_endpoint,omitempty"`
}
...
func (*UpstreamSslConfig_ConsulEndpoint) isUpstreamSslConfig_SslSecrets() {}
...
func (m *UpstreamSslConfig) GetConsulEndpoint() string {
	if x, ok := m.GetSslSecrets().(*UpstreamSslConfig_ConsulEndpoint); ok {
		return x.ConsulEndpoint
	}
	return ""
}
...
func (*UpstreamSslConfig) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*UpstreamSslConfig_ConsulEndpoint)(nil),
	}
}
...
var fileDescriptor_c4a65e8067d81add = []byte{
	...
	,
}
...
func (this *SslConfig_ConsulEndpoint) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*SslConfig_ConsulEndpoint)
	if !ok {
		that2, ok := that.(SslConfig_ConsulEndpoint)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.ConsulEndpoint != that1.ConsulEndpoint {
		return false
	}
	return true
}
...
func (this *UpstreamSslConfig_ConsulEndpoint) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*UpstreamSslConfig_ConsulEndpoint)
	if !ok {
		that2, ok := that.(UpstreamSslConfig_ConsulEndpoint)
		if ok {
			that1 = &that2
		} else {
			return false
